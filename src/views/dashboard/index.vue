  ...
  <div class="dashboard-container">
    ...
    <el-card class="header-card">
      <div>
       <div class="fl headL">
                 <div class="headImg">
                   <img :src="userResult.staffPhoto" v-imagerror="defaultImg">
                 </div>
                 <div class="headInfoTip">
                   <p class="firstChild">早安，{{ userResult.username }}，祝你开心每一天！</p>
                   <p class="lastChild">{{ userResult.username }}   |  {{ userResult.companyName }}-{{ userResult.departmentName }}</p>
                 </div>
               </div>
        <div class="fr" />
      </div>
  ...
  methods:{
	 btnOK() {
	       this.$refs.ruleForm.validate(async validate => {
	         if (validate) {
	           const data = { ...this.ruleForm, userId: this.userResult.userId }
